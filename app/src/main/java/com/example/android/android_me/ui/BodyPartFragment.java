...
public class BodyPartFragment extends Fragment {
    private static final String LOG = BodyPartFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(mImageList != null) {
            imageView.setImageResource(mImageList.get(1));
        }
        else {
            Log.e(LOG, "List not found!");
        }
    ...
    public void setImageList(List<Integer> bodyPartsList) {
        this.mImageList = bodyPartsList;
    }
